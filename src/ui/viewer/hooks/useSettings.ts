    ...
    authFetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_OLLAMA_BASE_URL: data.CLAUDE_MEM_OLLAMA_BASE_URL ?? DEFAULT_SETTINGS.CLAUDE_MEM_OLLAMA_BASE_URL,
          CLAUDE_MEM_OLLAMA_MODEL: data.CLAUDE_MEM_OLLAMA_MODEL ?? DEFAULT_SETTINGS.CLAUDE_MEM_OLLAMA_MODEL,
          CLAUDE_MEM_OLLAMA_NUM_CTX: data.CLAUDE_MEM_OLLAMA_NUM_CTX ?? DEFAULT_SETTINGS.CLAUDE_MEM_OLLAMA_NUM_CTX,
          CLAUDE_MEM_DEEPSEEK_API_KEY: data.CLAUDE_MEM_DEEPSEEK_API_KEY ?? DEFAULT_SETTINGS.CLAUDE_MEM_DEEPSEEK_API_KEY,
          CLAUDE_MEM_DEEPSEEK_MODEL: data.CLAUDE_MEM_DEEPSEEK_MODEL ?? DEFAULT_SETTINGS.CLAUDE_MEM_DEEPSEEK_MODEL,
          CLAUDE_MEM_DEEPSEEK_BASE_URL: data.CLAUDE_MEM_DEEPSEEK_BASE_URL ?? DEFAULT_SETTINGS.CLAUDE_MEM_DEEPSEEK_BASE_URL,
