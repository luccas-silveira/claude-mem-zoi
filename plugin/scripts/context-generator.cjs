"use strict";var vt=Object.create;var X=Object.defineProperty;var yt=Object.getOwnPropertyDescriptor;var Ut=Object.getOwnPropertyNames;var xt=Object.getPrototypeOf,wt=Object.prototype.hasOwnProperty;var kt=(r,e)=>{for(var t in e)X(r,t,{get:e[t],enumerable:!0})},Ae=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ut(e))!wt.call(r,n)&&n!==t&&X(r,n,{get:()=>e[n],enumerable:!(s=yt(e,n))||s.enumerable});return r};var M=(r,e,t)=>(t=r!=null?vt(xt(r)):{},Ae(e||!r||!r.__esModule?X(t,"default",{value:r,enumerable:!0}):t,r)),Ft=r=>Ae(X({},"__esModule",{value:!0}),r);var cs={};kt(cs,{generateContext:()=>he});module.exports=Ft(cs);var Lt=M(require("path"),1),Mt=require("os"),Dt=require("fs");var de=require("bun:sqlite");var f=require("path"),re=require("os"),D=require("fs");var Ne=require("url");var L=require("fs"),Re=require("path");var te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(te||{}),se=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Re.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=te[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{m=" "+this.formatData(o)}else m=" "+this.formatData(o);let T="";if(n){let{sessionId:g,memorySessionId:S,correlationId:b,...p}=n;Object.keys(p).length>0&&(T=` {${Object.entries(p).map(([h,l])=>`${h}=${l}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${c}${s}${T}${m}`;if(this.logFilePath)try{(0,L.appendFileSync)(this.logFilePath,E+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",T={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,T,n),o}},u=new se;var qt={};function Pt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Ne.fileURLToPath)(qt.url))}var $t=Pt();function Gt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,re.homedir)(),".claude-mem"),e=(0,f.join)(r,"settings.json");try{if((0,D.existsSync)(e)){let t=JSON.parse((0,D.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var O=Gt(),v=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,re.homedir)(),".claude"),fs=(0,f.join)(v,"plugins","marketplaces","thedotmack"),Ht=(0,f.join)(O,"archives"),Xt=(0,f.join)(O,"logs"),jt=(0,f.join)(O,"trash"),Bt=(0,f.join)(O,"backups"),Wt=(0,f.join)(O,"modes"),Ss=(0,f.join)(O,"settings.json"),Ce=(0,f.join)(O,"claude-mem.db"),Kt=(0,f.join)(O,"vector-db"),Ie=(0,f.join)(O,"observer-sessions"),ne=(0,f.basename)(Ie),bs=(0,f.join)(v,"settings.json"),hs=(0,f.join)(v,"commands"),Os=(0,f.join)(v,"CLAUDE.md");function Le(r){(0,D.mkdirSync)(r,{recursive:!0})}function Me(){return(0,f.join)($t,"..")}var x={dataDir:()=>O,workerPid:()=>(0,f.join)(O,"worker.pid"),settings:()=>(0,f.join)(O,"settings.json"),database:()=>(0,f.join)(O,"claude-mem.db"),chroma:()=>(0,f.join)(O,"chroma"),combinedCerts:()=>(0,f.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,f.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,f.join)(O,"transcript-watch-state.json"),corpora:()=>(0,f.join)(O,"corpora"),supervisorRegistry:()=>(0,f.join)(O,"supervisor.json"),envFile:()=>(0,f.join)(O,".env"),logsDir:()=>Xt,archives:()=>Ht,trash:()=>jt,backups:()=>Bt,modes:()=>Wt,vectorDb:()=>Kt,observerSessions:()=>Ie};var we=require("crypto");var ye=require("os"),oe=M(require("path"),1);var B=require("fs"),j=M(require("path"),1),w={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function De(r){let e=j.default.join(r,".git"),t;try{t=(0,B.statSync)(e)}catch(m){return m instanceof Error&&m.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",m),w}if(!t.isFile())return w;let s;try{s=(0,B.readFileSync)(e,"utf-8").trim()}catch(m){return console.warn("[worktree] Failed to read .git file:",m instanceof Error?m.message:String(m)),w}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return w;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return w;let a=i[1],d=j.default.basename(r),c=j.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:c}}var W=require("fs"),k=M(require("path"),1);function ve(r){if(!r||r.trim()==="")return null;let e;try{e=k.default.resolve(r)}catch{return null}let t=k.default.parse(e).root;for(;;){let s=k.default.join(e,".git");if((0,W.existsSync)(s))try{return(0,W.statSync)(s),e}catch{return null}if(e===t)return null;let n=k.default.dirname(e);if(n===e)return null;e=n}}function Ue(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,ye.homedir)()):r}function xe(r){let e=oe.default.basename(r);if(e!=="")return e;if(process.platform==="win32"){let s=r.match(/^([A-Z]):\\/i);if(s){let o=`drive-${s[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:o}),o}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}function Vt(r){if(!r||r.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=Ue(r),t=ve(e);return t?oe.default.basename(t):xe(e)}function ie(r){let e=Vt(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=Ue(r),s=De(t),n=xe(t),o=[e];if(n!==e&&!o.includes(n)&&o.push(n),s.isWorktree&&s.parentProjectName){let i=`${s.parentProjectName}/${e}`,a=[s.parentProjectName,i];return n!==e&&!a.includes(n)&&a.push(n),{primary:i,parent:s.parentProjectName,isWorktree:!0,allProjects:a}}return{primary:e,parent:null,isWorktree:!1,allProjects:o}}function K(r,e,t){return(0,we.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ae(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var R="claude";function Yt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return R;let e=Yt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:R}function ke(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Jt(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var q=class{db;constructor(e=Ce){e instanceof de.Database?this.db=e:(e!==":memory:"&&Le(O),this.db=new de.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addPendingMessagesToolUseIdAndWorkerPidColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.dropWorkerPidColumn()}dropWorkerPidColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32))return;if(this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid"))try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),u.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){u.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)))}this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}dropDeadPendingMessagesColumns(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31))return;let t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch","worker_pid"].filter(i=>s.has(i));if(o.length>0){this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)try{this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),u.debug("DB",`Dropped dead column ${i} from pending_messages`)}catch(a){u.warn("DB",`Failed to drop column ${i} from pending_messages`,{},a instanceof Error?a:new Error(String(a)))}}this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getAllProjects(e){let t=e?y(e):void 0,s=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[ne];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(R,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).get(e);if(m){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let E=m.platform_source?.trim()?y(m.platform_source):void 0;if(!E)this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),m=K(e,s.title,s.narrative),E=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let c=a??Date.now(),m=new Date(c).toISOString();return this.db.transaction(()=>{let E=[],g=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let p of s){let A=K(e,p.title,p.narrative),h=g.get(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),o||null,i,p.agent_type??null,p.agent_id??null,A,m,c,d||null);if(h){E.push(h.id);continue}let l=S.get(e,A);if(!l)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${A}`);E.push(l.id)}let b=null;if(n){let A=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,m,c);b=Number(A.lastInsertRowid)}return{observationIds:E,summaryId:b,createdAtEpoch:c}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,c,m){let T=c??Date.now(),E=new Date(T).toISOString();return this.db.transaction(()=>{let S=[],b=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),p=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let l of s){let I=K(e,l.title,l.narrative),U=b.get(e,t,l.type,l.title,l.subtitle,JSON.stringify(l.facts),l.narrative,JSON.stringify(l.concepts),JSON.stringify(l.files_read),JSON.stringify(l.files_modified),a||null,d,l.agent_type??null,l.agent_id??null,I,E,T,m||null);if(U){S.push(U.id);continue}let Oe=p.get(e,I);if(!Oe)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${I}`);S.push(Oe.id)}let A;if(n){let I=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,E,T);A=Number(I.lastInsertRowid)}return this.db.prepare(`
    ...
    `).all(...m);if(!i)return g;let S=new Map(g.map(b=>[b.id,b]));return e.map(b=>S.get(b)).filter(b=>!!b)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),m=[...e],T=o?"AND s.project = ?":"";o&&m.push(o);let g=this.db.prepare(`
      ...
      ${a}
      ${d}
    `).all(...m);if(!i)return g;let S=new Map(g.map(b=>[b.id,b]));return e.map(b=>S.get(b)).filter(b=>!!b)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,c;if(e!==null){let p=`
  ...
  `).all(e,e,...s,...o,t.totalObservationCount)}function Ee(r,e,t){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+me)}function Ge(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
...
`}function ft(r,e,t,s){let n=[];return s?n.push(...ot(r)):n.push(...We(r)),s?n.push(...it()):n.push(...Ke()),s?n.push(...at()):n.push(...qe()),s?n.push(...dt()):n.push(...Ve()),J(t)&&(s?n.push(..._t(e,t)):n.push(...Ye(e,t))),n}var fe=M(require("path"),1);function ee(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Se(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function be(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function bt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function St(r,e){return fe.default.isAbsolute(r)?fe.default.relative(e,r):r}function ht(r,e,t){let s=ee(r);if(s.length>0)return St(s[0],e);if(t){let n=ee(t);if(n.length>0)return St(n[0],e)}return"General"}function ns(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=bt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Ot(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?ee(r.facts).join(`
`):null}function os(r,e,t,s){let n=[];n.push(...Je(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Se(a.displayTime);n.push(...et(a,d))}else{let a=i.data,d=be(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let E=Ot(a,s);n.push(...Ze(a,m,E,s))}else n.push(ze(a,m,s))}return n}function is(r,e,t,s,n){let o=[];o.push(...ut(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,m=Se(c.displayTime);o.push(...pt(c,m))}else{let c=d.data,m=ht(c.files_modified,n,c.files_read),T=be(c.created_at),E=T!==a;a=T;let g=t.has(c.id);if(m!==i&&(o.push(...mt(m)),i=m),g){let S=Ot(c,s);o.push(...lt(c,T,E,S,s))}else o.push(ct(c,T,E,s))}return o.push(""),o}function as(r,e,t,s,n,o){return o?is(r,e,t,s,n):os(r,e,t,s)}function At(r,e,t,s,n){let o=[],i=ns(r);for(let[a,d]of i)o.push(...as(a,d,e,t,s,n));return o}function Rt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Nt(r,e){let t=[];return e?(t.push(...H("Investigated",r.investigated,_.blue)),t.push(...H("Learned",r.learned,_.yellow)),t.push(...H("Completed",r.completed,_.green)),t.push(...H("Next Steps",r.next_steps,_.magenta))):(t.push(...G("Investigated",r.investigated)),t.push(...G("Learned",r.learned)),t.push(...G("Completed",r.completed)),t.push(...G("Next Steps",r.next_steps))),t}function Ct(r,e){return e?Et(r):tt(r)}function It(r,e,t){return!J(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?gt(r.totalDiscoveryTokens,r.totalReadTokens):st(r.totalDiscoveryTokens,r.totalReadTokens)}var ds=Lt.default.join((0,Mt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function _s(){try{return new q}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Dt.unlinkSync)(ds)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function us(r,e){return e?Tt(r):rt(r)}function ms(r,e,t,s,n,o,i){let a=[],d=le(e);a.push(...ft(r,d,s,i));let c=t.slice(0,s.sessionCount),m=Xe(c,t),T=Te(e,m),E=je(e,s.fullObservationCount);a.push(...At(T,E,s,n,i));let g=t[0],S=e[0];Rt(s,g,S)&&a.push(...Nt(g,i));let b=ge(e,s,o,n);return a.push(...Ct(b,i)),a.push(...It(d,s,i)),a.join(`
`).trimEnd()}async function he(r,e=!1){let t=ue(),s=r?.cwd??process.cwd(),n=ie(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=_s();if(!a)return"";try{let d=o.length>1?Ge(a,o,t):pe(a,i,t),c=o.length>1?He(a,o,t):Ee(a,i,t);return d.length===0&&c.length===0?us(i,e):ms(i,d,c,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
